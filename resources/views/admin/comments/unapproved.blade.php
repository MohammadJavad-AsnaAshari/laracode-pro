@component("admin.layouts.contenct", ["title" => "لیست نظرات تایید نشده"])
    @slot("breadcrumb")
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">فرم نظرات تایید نشده</h3>
                                ...
                                <td class="d-flex">
                                    @can("edit-comment")
                                        <form action="{{route("admin.comments.update", ["comment" => $comment->id])}}"
                                            ...
                                            @csrf
                                            @method("patch")
                                            <button class="btn btn-success btn-sm mr-1">تایید</button>
                                        </form>
                                    @endcan
                                    @can("delete-comment")
